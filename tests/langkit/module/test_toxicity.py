...
def test_prompt_toxicity_row_non_toxic():
    schema = EvaluationConfifBuilder().add(prompt_toxicity_module).build()
...
def test_response_toxicity_row_non_toxic():
    schema = EvaluationConfifBuilder().add(response_toxicity_module).build()
...
def test_prompt_response_toxicity_row_non_toxic():
    schema = EvaluationConfifBuilder().add(prompt_response_toxicity_module).build()
